...
export default function Contact() {
  ...
  <div className="w-full px-3">
    <label className="block uppercase tracking-wide text-black_olive-500 text-xs font-bold mb-2" htmlFor="grid-message">
      Message
    </label>
    <textarea
      name='message'
      className="resize-y appearance-none block w-full bg-spanish_orange-900 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
      id="grid-message"
